...
public class Hadoop {
	...
	protected final String URL = "hdfs://192.168.3.179:9000";
	protected final String LOCAL = "D:\\data\\";//"/root/data/";
	...
	protected boolean init(String fileName) {
		...
		try {
			...
			if (hadoopSystem.exists(inputPath)) {
				hadoopSystem.delete(inputPath);
			}
			hadoopSystem.create(inputPath);
